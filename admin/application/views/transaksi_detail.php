<div class="container">
	<div class="row mb-5">
		<div class="col-md-3">
			<h5 class="fs-4 fw-bold">Transaksi</h5>
		...
		<div class="col-md-3">
			<h5 class="fs-4 fw-bold">Pengirim</h5>
		...
		<div class="col-md-3">
			<h5 class="fs-4 fw-bold">Penerima</h5>
		...
		<div class="col-md-3">
			<h5 class="fs-4 fw-bold">Ekspedisi</h5>
	...
	<h5 class="fs-4 fw-bold mb-3">Detail Transaksi Produk</h5>
	<table class="table table-bordered">
		...
		<tfoot>
			...
			<tr>
				<td colspan="3"><b>Total Harus Dibayar</b></td>
