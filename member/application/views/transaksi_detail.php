	...
	<table class="table table-bordered">
		...
		<tbody>
			...
			<tr>
				...
				<td>Rp<?php echo number_format($value['harga_beli'] * $value['jumlah_beli']) ?></td>
			</tr>
			<?php endforeach ?>
		</tbody>
		<tfoot>
			<tr>
				...
				<th>Rp<?php echo number_format($transaksi['belanja_transaksi']) ?></th>
			</tr>
			<tr>
				<td colspan="3">Ongkos Kirim</td>
				<th>Rp<?php echo number_format($transaksi['ongkir_transaksi']) ?></th>
			</tr>
			<tr>
				<td colspan="3">Total Harus Dibayar</td>
				<th>Rp<?php echo number_format($transaksi['total_transaksi']) ?></th>
			</tr>
		</tfoot>
	</table>
...
<?php if (!empty($snapToken)): ?>
    ...
    <script src="https://app.sandbox.midtrans.com/snap/snap.js" data-client-key="SB-Mid-client-8ncoHFTSsA66xb2c"></script>
