...
class Transaksi extends CI_Controller {
	...
	public function index() {
		...
		// Panggil model Mtransaksi dan fungsi transaksi member beli(id_member yang login)
	...
	function detail($id_transaksi) {
		...
		if ($data['transaksi']['status_transaksi']=='pesan') {
			...
			\Midtrans\Config::$serverKey = 'SB-Mid-server-FcpOuLiISbRxW6-tXoqeBCtA';
			...
			curl_setopt_array($curl, array(
			  ...
			  CURLOPT_HTTPHEADER => array(
			    "accept: application/json", "authorization: Basic U0ItTWlkLXNlcnZlci1GY3BPdUxpSVNiUnhXNi10WG9xZUJDdEE6YW1pa29t"
			  ),
			));
